...
SEGMENTER_COMMAND_L="$SEGMENTER_CMD -w $PART_TARGET_DURATION -t $TARGET_DURATION $ADDRESS:$PORT_L -s $SLIDING_WINDOW -D -T -f ./$WEB_L/ -W"
SEGMENTER_COMMAND_P="$SEGMENTER_CMD -w $PART_TARGET_DURATION -t $TARGET_DURATION $ADDRESS:$PORT_P -s $SLIDING_WINDOW -D -T -f ./$WEB_P/ -W"
SEGMENTER_COMMAND_O="$SEGMENTER_CMD -w $PART_TARGET_DURATION -t $TARGET_DURATION $ADDRESS:$PORT_O -s $SLIDING_WINDOW -D -T -f ./$WEB_O/ -W"
